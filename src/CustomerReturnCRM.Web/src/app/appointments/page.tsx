...
function JalaliDatePicker({ value, onChange }: { value: string; onChange: (value: string) => void }) {
  ...
  return <div className="relative">
    ...
    {open && <><button type="button" aria-label="بستن تقویم" onClick={() => setOpen(false)} className="fixed inset-0 z-30 cursor-default" /><div className="absolute right-0 top-full z-40 mt-2 w-[320px] rounded-2xl border border-slate-200 bg-white p-3 shadow-2xl">
...
function CustomerPicker({ customers, value, onChange }: { customers: Customer[]; value: string; onChange: (id: string) => void }) {
  ...
  return <div className="relative">
    ...
    {open && <><button type="button" aria-label="بستن انتخاب مشتری" onClick={() => setOpen(false)} className="fixed inset-0 z-30 cursor-default" /><div className="absolute right-0 top-full z-40 mt-2 w-full min-w-[320px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl">
