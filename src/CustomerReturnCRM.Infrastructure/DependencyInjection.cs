...
using CustomerReturnCRM.Infrastructure.PublicBooking;
using CustomerReturnCRM.Infrastructure.Bale;
using CustomerReturnCRM.Infrastructure.BusinessCard;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IBusinessCardSharingService, BusinessCardSharingService>();
        ...
        services.AddHttpClient("Bale", client => client.BaseAddress = new Uri("https://tapi.bale.ai/"));
