...
namespace CustomerReturnCRM.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914110148_AddBaleIntegration")]
            ...
            modelBuilder.Entity("CustomerReturnCRM.Domain.Entities.BaleConnectToken", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "CustomerId", "ExpiresAtUtc");

                    b.ToTable("BaleConnectToken", (string)null);
                });
            ...
            modelBuilder.Entity("CustomerReturnCRM.Domain.Entities.BaleCustomerIdentity", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "BaleUserId")
                        .IsUnique();

                    b.HasIndex("BusinessId", "CustomerId")
                        .IsUnique();

                    b.ToTable("BaleCustomerIdentity", (string)null);
                });
            ...
            modelBuilder.Entity("CustomerReturnCRM.Domain.Entities.SmsCampaign", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "Status", "ScheduledAt");

                    b.ToTable("SmsCampaigns", (string)null);
                });

            modelBuilder.Entity("CustomerReturnCRM.Domain.Entities.SmsRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SmsCampaignId", "CustomerId")
                        .IsUnique();

                    b.HasIndex("SmsCampaignId", "Status");

                    b.ToTable("SmsRecipients", (string)null);
                });

            modelBuilder.Entity("CustomerReturnCRM.Domain.Entities.SmsTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CustomerReturnCRM.Domain.Entities.SmsCampaign", b =>
                {
                    ...
                    b.HasOne("CustomerReturnCRM.Domain.Entities.SmsTemplate", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("CustomerReturnCRM.Domain.Entities.SmsRecipient", b =>
                {
                    ...
                    b.HasOne("CustomerReturnCRM.Domain.Entities.SmsCampaign", "SmsCampaign")
                        .WithMany("Recipients")
