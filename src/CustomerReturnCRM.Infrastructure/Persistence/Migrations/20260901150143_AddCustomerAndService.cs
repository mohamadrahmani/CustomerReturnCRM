...
{
    /// <inheritdoc />
    public partial class AddCustomerAndService : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_BusinessId_Mobile",
                table: "Customers",
                columns: new[] { "BusinessId", "Mobile" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Services_BusinessId_Title",
                table: "Services",
                columns: new[] { "BusinessId", "Title" },
                unique: true);
        }
